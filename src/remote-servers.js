...
// git remote -v --> shows all remote servers
// git remote show [remote name] --> shows more info about remote server
...
// git remote rename [old] [new]--> rename server address name
